...
- [this cheap USB splitter](https://www.amazon.com/dp/B0DPPTCXXK) 
	- optional button-on-a-cable which seems great for cars
	- doesn't require external power
 - two [Mini Wireless CarPlay Adapters](https://www.amazon.com/dp/B0DPPTCXXK)
	 - instant auto-connect
	 - only single-device support (actually a strong bonus for us)

Works great so far!

![[USB Switch + CarPlay adapters (boxed).jpg]]
![[USB Switch + CarPlay adapters (unboxed).jpg]]
![[USB Switch + CarPlay adapters (in car).jpg]]